...
export const App = () => {
    return (_jsx(QueryClientProvider, { client: queryClient, children: _jsxs(BrowserRouter, { children: [_jsx(SessionBootstrap, {}), _jsx(AddToHomeScreenPrompt, {}), _jsxs(Routes, { children: [_jsx(Route, { path: "/login", element: _jsx(LoginPage, {}) }), _jsx(Route, { path: "/fila/:token", element: _jsx(PublicQueuePage, {}) }), _jsx(Route, { path: "/conta/senha", element: _jsx(RequireSession, { children: _jsx(AccountChangePasswordPage, {}) }) }), _jsx(Route, { path: "/conta/preferencias", element: _jsx(RequireSession, { children: _jsx(AccountPreferencesPage, {}) }) }), _jsx(Route, { path: "/admin", element: _jsx(Navigate, { to: "/admin/brechos", replace: true }) }), _jsx(Route, { path: "/admin/brechos", element: _jsx(RequireFounder, { children: _jsx(AdminBrechosPage, {}) }) }), _jsx(Route, { path: "/admin/brechos/new", element: _jsx(RequireFounder, { children: _jsx(AdminBrechoFormPage, {}) }) }), _jsx(Route, { path: "/admin/brechos/:brechoId", element: _jsx(RequireFounder, { children: _jsx(AdminBrechoDetailPage, {}) }) }), _jsx(Route, { path: "/", element: _jsx(RequireAuth, { children: _jsx(InventoryPage, {}) }) }), _jsx(Route, { path: "/items/new", element: _jsx(RequireAuth, { children: _jsx(ItemCreateChoicePage, {}) }) }), _jsx(Route, { path: "/items/new/ai", element: _jsx(RequireAuth, { children: _jsx(ItemAIDraftPage, {}) }) }), _jsx(Route, { path: "/importacoes/criar", element: _jsx(RequireAuth, { children: _jsx(ImportacaoCriarPage, {}) }) }), _jsx(Route, { path: "/importacoes/:loteId/criar", element: _jsx(RequireAuth, { children: _jsx(ImportacaoCriarPage, {}) }) }), _jsx(Route, { path: "/importacoes/:loteId/grupos", element: _jsx(RequireAuth, { children: _jsx(ImportacaoGruposPage, {}) }) }), _jsx(Route, { path: "/importacoes/:loteId/rascunhos/:rascunhoId", element: _jsx(RequireAuth, { children: _jsx(ImportacaoRascunhoDetailPage, {}) }) }), _jsx(Route, { path: "/importacoes/:loteId/rascunhos", element: _jsx(RequireAuth, { children: _jsx(ImportacaoRascunhosPage, {}) }) }), _jsx(Route, { path: "/importacoes", element: _jsx(RequireAuth, { children: _jsx(ImportacaoInboxPage, {}) }) }), _jsx(Route, { path: "/items/new/manual", element: _jsx(RequireAuth, { children: _jsx(ItemManualCreatePage, {}) }) }), _jsx(Route, { path: "/items/:itemId", element: _jsx(RequireAuth, { children: _jsx(ItemDetailPage, {}) }) }), _jsx(Route, { path: "/items/:itemId/fotos/upload", element: _jsx(RequireAuth, { children: _jsx(ItemFotoUploadPage, {}) }) }), _jsx(Route, { path: "/reserve/:itemId", element: _jsx(RequireAuth, { children: _jsx(ReservePage, {}) }) }), _jsx(Route, { path: "/sell/batch", element: _jsx(RequireAuth, { children: _jsx(SellBatchPage, {}) }) }), _jsx(Route, { path: "/sell/:itemId", element: _jsx(RequireAuth, { children: _jsx(SellPage, {}) }) }), _jsx(Route, { path: "/vendas", element: _jsx(RequireAuth, { children: _jsx(SalesHubPage, {}) }) }), _jsx(Route, { path: "/deliveries", element: _jsx(RequireAuth, { children: _jsx(DeliveriesPage, {}) }) }), _jsx(Route, { path: "/clientes", element: _jsx(RequireAuth, { children: _jsx(ClientsPage, {}) }) }), _jsx(Route, { path: "/clientes/:clientId", element: _jsx(RequireAuth, { children: _jsx(ClientDetailPage, {}) }) }), _jsx(Route, { path: "/relatorios", element: _jsx(RequireAuth, { children: _jsx(ReportsPage, {}) }) }), _jsx(Route, { path: "/ai/quality", element: _jsx(RequireAuth, { children: _jsx(AiQualityPage, {}) }) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/", replace: true }) })] })] }) }));
};
