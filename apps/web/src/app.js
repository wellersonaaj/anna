...
export const App = () => {
    return (_jsx(QueryClientProvider, { client: queryClient, children: _jsx(BrowserRouter, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(InventoryPage, {}) }), _jsx(Route, { path: "/items/new/ai", element: _jsx(ItemAIDraftPage, {}) }), _jsx(Route, { path: "/items/:itemId", element: _jsx(ItemDetailPage, {}) }), _jsx(Route, { path: "/items/:itemId/fotos/upload", element: _jsx(ItemFotoUploadPage, {}) }), _jsx(Route, { path: "/reserve/:itemId", element: _jsx(ReservePage, {}) }), _jsx(Route, { path: "/sell/:itemId", element: _jsx(SellPage, {}) }), _jsx(Route, { path: "/deliveries", element: _jsx(DeliveriesPage, {}) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/", replace: true }) })] }) }) }));
};
