...
export const ItemStatusTone = ({ status, compact = false, variant = "soft" }) => {
    const softToneMap = {
    ...
    return (_jsx("span", { className: cx("inline-flex rounded-full font-bold uppercase tracking-wider", tone.bg, tone.text, variant === "overlay" && "shadow-sm", compact ? "px-2 py-0.5 text-[10px]" : "px-3 py-1 text-[9px]"), children: tone.label }));
};
