...
export const ItemDetailPage = () => {
    ...
    const saleFreteCusto = item?.venda?.freteCustoLoja != null ? parseMoneyLike(item.venda.freteCustoLoja) : null;
    const saleEmbalagemCusto = item?.venda?.embalagemCusto != null ? parseMoneyLike(item.venda.embalagemCusto) : null;
    const saleLucroBruto = item?.venda && !Number.isNaN(salePrecoVenda)
        ? computeLucroBruto(salePrecoVenda, salePrecoCusto)
        : null;
    const saleLucroOperacional = item?.venda && !Number.isNaN(salePrecoVenda)
