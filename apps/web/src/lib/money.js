const normalizeSingleSeparatorNumber = (raw, separator) => {
...
const sanitizeMoneyString = (value) => value
    .trim()
    .replace(/\s+/g, "")
    .replace(/[Rr]\$/g, "")
    .replace(/[^\d,.-]/g, "");
...
export const formatCurrencySafe = (value, fallback = "Preço a confirmar") => {
